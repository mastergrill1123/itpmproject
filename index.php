					...
					<!-- Banner -->
						<div id="banner">
							<div class="container">
								<section>
									<header class="major">
										<h2>Welcome to Mastergrill!</h2>
										<span class="byline">A place to eat and chill</span>

										<p></p>
										<p></p>

										<iframe width="700" height="400" src="https://www.youtube.com/embed/FOLHgoRcMHU?autoplay=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>

										<p></p>
										<p></p>

										<iframe width="500" height="300" src="https://maps.tilehosting.com/c/9ad13999-9af5-4359-b25c-b62364b8dbef/styles/basic/?key=mWoDi6HvzoWKQxrAK6Tx"></iframe>
									</header>
		...
		<!-- Featured -->
			<div class="wrapper style2">
				<section class="container">
					<header class="major">
						<h2>What's New in Mastergrill</h2>
